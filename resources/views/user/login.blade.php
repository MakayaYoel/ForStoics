...
@section('content')
    <div class="h-screen flex justify-center">
        <div class="self-center h-4/6 w-1/4 flex flex-col mb-12">
            <h1 class="text-center text-white font-bold text-3xl mt-4">Login</h1>
            <form action="/login" method="POST" class="flex flex-col self-center w-full font-serif mt-6">
                @csrf
                ...
                <input type="submit" value="Login" class="w-full border-2 rounded h-12 text-white text-xl hover:bg-neutral-700 cursor-pointer">
            </form>
        </div>
    </div>
@endsection